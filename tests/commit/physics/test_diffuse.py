...
class TestDiffusion(TestCase):
    ...
    def test_diffuse_centered_batched(self):
        ...
        diffuse.implicit(grid, 1, 1, solve=Solve('scipy-direct'))
    ...
    def test_diffuse_staggered_batched(self):
        for diffusivity in [1, 0.5, math.wrap([1., 0.5], batch('batch'))]:
            ...
            diffuse.implicit(grid, diffusivity, 1, solve=Solve('scipy-direct'))
    ...
    def test_constant_diffusion(self):
        ...
        implicit = diffuse.implicit(grid, 1, 1, solve=Solve('scipy-direct'))
    ...
    def test_equality_1d_periodic(self):
        ...
        implicit = diffuse.implicit(grid, DIFFUSIVITY, 1, solve=Solve('scipy-direct'))
