...
class Mesh(Geometry):
    ...
    def filter_unused_vertices(self) -> 'Mesh':
        ...
        return Mesh(vertices, elements, self._element_rank, self._boundaries, self._center, self._volume, self._face_centers, self._face_normals, self._face_areas, None, None, self._element_connectivity, self._max_cell_walk)
