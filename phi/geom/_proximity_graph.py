...
class ProximityGraph(Geometry):
    ...
    def __with_attrs__(self, **attrs):  # Make sure cached distances are invalidated
        ...
        return ProximityGraph(**construct_kwargs)
    ...
    def lies_inside(self, location: Tensor) -> Tensor:
        raise NotImplementedError(f"lies_inside not defined for ProximityGraph")

    def approximate_signed_distance(self, location: Union[Tensor, tuple]) -> Tensor:
        raise NotImplementedError(f"approximate_signed_distance not defined for ProximityGraph")

    def sample_uniform(self, *shape: math.Shape) -> Tensor:
        raise NotImplementedError(f"sample_uniform not defined for ProximityGraph")
    ...
    def rotated(self, angle: Union[float, Tensor]) -> 'Geometry':
        raise NotImplementedError(f"rotated not defined for ProximityGraph")

    def scaled(self, factor: Union[float, Tensor]) -> 'Geometry':
        return ProximityGraph(self._nodes.scaled(factor), self._boundary, self._kernel, self._format)  # this may add more connections
