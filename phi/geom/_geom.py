...
class Geometry:
    ...
    * box family: box (generator), Box, Cuboid, AbstractBox
    ...
    def approximate_fraction_inside(self, other_geometry: 'Geometry', balance : Tensor) -> Tensor:
        ...
        The balance parameter controls if the interpolation zone will be completely inside (0), outside (1) or somewhere in between (0 < balance < 1).
        ...
        Args:
          ...
          balance: interpolation zone balance
