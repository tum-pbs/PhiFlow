...
def get_color_interpolation(val, cm_arr):
    ...
    if 0 in cm_arr[:, 0] - val:
        ...
        color1 = cm_arr[np.argmax(offset_positions[offset_positions < 0])]  # largest value smaller than control
        color2 = cm_arr[np.argmin(offset_positions[offset_positions > 0])]  # smallest value larger than control
