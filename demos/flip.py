...
initial_points = _distribute_points(point_mask, 8)
...
obstacle_points = _distribute_points(obstacle_mask, 2)
...
def step(particles, v_field, pressure, dt, t, **kwargs):
    ...
    particles = advect.advect(particles, v_div_free_field, dt, smask=smask, bcs=bcs, mode='rk4_extp')
    if t < inflow:
