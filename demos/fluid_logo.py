...
for _ in view(display=['smoke', 'velocity', 'pressure', 'OBSTACLE_MASK'], play=False).range():
    ...
    velocity, pressure_result = fluid.make_incompressible(velocity, DOMAIN, (OBSTACLE,), Solve('CG-adaptive', 1e-5, 0, x0=pressure))
