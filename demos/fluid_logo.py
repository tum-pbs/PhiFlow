...
OBSTACLE_MASK = DOMAIN.grid(HardGeometryMask(OBSTACLE.geometry))

inflow = DOMAIN.grid(Box[14:21, 6:10]) + DOMAIN.grid(Box[79:86, 6:10]) * 0.8 + DOMAIN.grid(Box[43:46, 49:50]) * 0.1
