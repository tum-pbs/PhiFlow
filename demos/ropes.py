...
positions = math.tensor([(i*0.4, 0) for i in range(10)] + [(5, 0), (4.5, -0.5), (4.5, 0.5)], instance('positions'), channel('vector'))
fixed = math.tensor([True] + [False] * 12, instance('positions'))
sticks = math.tensor([(i, i+1) for i in range(9)] + [(9, 11), (9, 12), (10, 11), (10, 12), (11, 12)], instance('sticks, ab'))

id_a, id_b = math.unstack(sticks, 'ab')
id_ab = math.concat([id_a, id_b], id_a.shape)
